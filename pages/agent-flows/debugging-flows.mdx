...
description: "How to debug agent flows in Methodius AI"
---
...
You can view the logs of an executed flow by [opening the logs of Methodius AI](/installation-desktop/debug).
