...
description: "How to debug agent flows in Methodius"
---
...
You can view the logs of an executed flow by [opening the logs of Methodius](/installation-desktop/debug).
