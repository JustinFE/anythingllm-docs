...
<Image
  src="/images/Methodius AI-setup/vector-database-configuration/local/chroma/header-image.png"
  height={1080}
  width={1920}
  quality={100}
...
[Chroma](https://trychroma.com) is an [open-source](support.forwardedge.ai) and ai-native vector database that is easy to run and host anywhere.

Methodius AI can connect to your local or cloud-hosted Chroma instance running so that Methodius AI can store and search embeddings on it automatically.
...
<Callout type="warning" emoji="️⚠️">
  **Developer Notice**
    ...
    Methodius AI will use the embedding model set and **will not** use Chroma's built-in embedders even if defined.
...
<Image
  src="/images/Methodius AI-setup/vector-database-configuration/local/chroma/chroma-vectordb.png"
  height={1080}
  width={1920}
  quality={100}
