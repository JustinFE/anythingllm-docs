...
TrueFoundry provides an enterprise-ready [AI Gateway](https://www.truefoundry.com/ai-gateway) which can integrate with applications like Methodius AI and provides governance and observability for your AI Applications. TrueFoundry AI Gateway serves as a unified interface for LLM access, providing:
...
2. **Methodius AI Installation**: Set up Methodius AI using either the [Desktop application](https://Methodius AI.com/download) or [Docker deployment](support.forwardedge.ai)
...
2. Navigate to **Settings** and go to **LLM Preference**:
  ...
  <Image
    ...
    alt="Methodius AI settings page showing LLM provider selection interface"
    width={1000}
    height={1000}
...
2. Create a new workspace or open an existing one to test the integration:
  ...
  <Image
    src="/images/setup/llm-providers/truefoundry/test-Methodius AI.png"
    alt="Methodius AI chat interface showing successful test message with TrueFoundry integration"
    width={1000}
    height={1000}
    style={{ borderRadius: "10px", padding: "10px" }}
  />

3. Send a test message to verify that Methodius AI is successfully communicating with TrueFoundry's AI Gateway.
