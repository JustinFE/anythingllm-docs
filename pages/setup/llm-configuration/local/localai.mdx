...
[LocalAI](https://localai.io) is a popular [open-source](support.forwardedge.ai), API, and LLM engine that allows you to download and run any GGUF model from HuggingFace and run it on CPU or GPU.
...
<Image
  src="/images/Methodius AI-setup/llm-configuration/local/localai/localai-llm.png"
  height={1080}
  width={1920}
  quality={100}
