...
description: "This guide explain how to setup AI Agents on Methodius AI"
---
...
<Image
  src="/images/Methodius AI-setup/agent-configuration/configuration-menu.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Methodius AI Agent Configuration Menu"
/>
...
<Image
  src="/images/Methodius AI-setup/agent-configuration/llm.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Methodius AI Agent LLM"
/>

After updating the workspace agent settings, click the "Configure Agent Skills" button.

<Image
  src="/images/Methodius AI-setup/agent-configuration/configure-agent-skills-button.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Methodius AI Agent LLM"
...
<Callout type="info" emoji="️ℹ️">
  **Note**
    ...
    Methodius AI supports a lot of LLM providers for use with `@agent`s and you can see all the supported LLMs from [here](https://docs.Methodius AI.com/features/language-models#supported-language-model-providers)
...
<Image
  src="/images/Methodius AI-setup/agent-configuration/tools.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Methodius AI Agent Skills"
/>
...
<Image
  src="/images/Methodius AI-setup/agent-configuration/search.png"
  height={1080}
  width={1920}
  quality={100}
  alt="Methodius AI Agent Web Browsing"
/>

With Google Search Engine you can perform up to 100 search for free everyday.

**That's it! You can now use Methodius AI's Agents!**
