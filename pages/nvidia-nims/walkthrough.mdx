---
title: "Walkthrough"
description: "Learn how to use NVIDIA NIM in Methodius AI."
---
...
The use of NVIDIA NIM in Methodius AI is very simple and straightforward - all of the complexity is hidden from you by the Methodius AI Desktop client or the NVIDIA NIM Installer.


## Select the NVIDIA NIM LLM Provider

In Methodius AI Desktop, select the `NVIDIA NIM` LLM provider from the dropdown menu - this will show your the default NIM connector.
...
The official NVIDIA NIM installer is a pre-built binary that runs in the Methodius AI Desktop client built by NVIDIA. If your system or GPU is not compatible with running a NIM, you will see an error message during this step and will be unable to run a NIM on Methodius AI or your system in general.
...
After closing the completed NIM installer, you will see the blue button change to "Swap to Managed Mode". Clicking on this button will allow Methodius AI to manage your NIM models for you via a simple UI.
...
This is the recommended mode of operation for Methodius AI as it will allow you to easily update your NIM models and manage your NIM instances. Once you have swapped to managed mode, you will see the NIM manager UI with no models.
...
This means that your NIM is ready to use! You can now start using it in Methodius AI.

## Selecting your NIM in Methodius AI

To select your NIM in Methodius AI, simply click on the model card for the NIM you want to use and click "Save changes" in the top right.
...
You can now use this model in Methodius AI as you would any other model or provider.
...
Closing Methodius AI currently does not stop the NIM - so you will need to manually stop the NIM by clicking on the "Stop NIM" button in the NIM manager UI.
