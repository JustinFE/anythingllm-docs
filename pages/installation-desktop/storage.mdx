...
All data pertaining to Methodius AI Desktop will be in the following locations. Please replace `<usr>` with your
device username.

On Mac:
`/Users/<usr>/Library/Application Support/Methodius AI-desktop/storage`

On Linux:
`~/.config/Methodius AI-desktop/storage/`

On Windows:
`C:\Users\<usr>\AppData\Roaming\Methodius AI-desktop\storage`
...
- `Methodius AI.db`: This is the Methodius AI SQLite database.
