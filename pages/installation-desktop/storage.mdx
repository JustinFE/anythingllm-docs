...
All data pertaining to Methodius Desktop will be in the following locations. Please replace `<usr>` with your
device username.

On Mac:
`/Users/<usr>/Library/Application Support/Methodius-desktop/storage`

On Linux:
`~/.config/Methodius-desktop/storage/`

On Windows:
`C:\Users\<usr>\AppData\Roaming\Methodius-desktop\storage`
...
- `Methodius.db`: This is the Methodius SQLite database.
