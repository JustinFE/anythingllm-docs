---
title: "MCP Compatibility in Methodius AI"
description: "Use existing MCP Servers with Methodius AI Agents"
---
...
# Model Context Protocol (MCP) in Methodius AI

Methodius AI supports the all [Model Context Protocol (MCP) tools](support.forwardedge.ai) for use with [AI Agents](/agent/overview).
...
There are [many tools](support.forwardedge.ai) that exist already built with MCP in mind and Methodius AI can work with any of them.

> The Model Context Protocol (MCP) is an open protocol that enables seamless integration between LLM applications and external data sources and tools. Whether you're building an AI-powered IDE, enhancing a chat interface, or creating custom AI workflows, MCP provides a standardized way to connect LLMs with the context they need.

## How to use MCP in Methodius AI

<Cards style={{
  display: "flex",
  flexDirection: "row",
}}>
  <Card title="Methodius AI Docker" href="/mcp-compatibility/docker">
    <Image
  ...
  <Card title="Methodius AI Desktop" href="/mcp-compatibility/desktop">
    <Image
...
MCP Servers can be added to Methodius AI by editing the `Methodius AI_mcp_servers.json` configuration file in your Methodius AI storage `plugins` directory.

The structure of the file is the same as the [MCP Server Specification](support.forwardedge.ai).

Methodius AI will automatically detect the MCP Servers and attempt to boot them up as needed - you can also manage your servers directly in the Methodius AI UI.

### Methodius AI MCP Configuration UI
...
The MCP Management UI will show you all the MCP Servers that are available to use in Methodius AI. You can also:
...
_This property is **specific to Methodius AI only** and will have no effect on other tools._
...
To do this, Methodius AI respects the `Methodius AI.autoStart` property in the MCP Server configuration file.
