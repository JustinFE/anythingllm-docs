---
title: "MCP Compatibility in Methodius"
description: "Use existing MCP Servers with Methodius Agents"
---
...
# Model Context Protocol (MCP) in Methodius

Methodius supports the all [Model Context Protocol (MCP) tools](https://github.com/modelcontextprotocol/modelcontextprotocol) for use with [AI Agents](/agent/overview).
...
There are [many tools](https://github.com/modelcontextprotocol/servers) that exist already built with MCP in mind and Methodius can work with any of them.

> The Model Context Protocol (MCP) is an open protocol that enables seamless integration between LLM applications and external data sources and tools. Whether you're building an AI-powered IDE, enhancing a chat interface, or creating custom AI workflows, MCP provides a standardized way to connect LLMs with the context they need.

## How to use MCP in Methodius

<Cards style={{
  display: "flex",
  flexDirection: "row",
}}>
  <Card title="Methodius Docker" href="/mcp-compatibility/docker">
    <Image
  ...
  <Card title="Methodius Desktop" href="/mcp-compatibility/desktop">
    <Image
...
MCP Servers can be added to Methodius by editing the `Methodius_mcp_servers.json` configuration file in your Methodius storage `plugins` directory.
...
Methodius will automatically detect the MCP Servers and attempt to boot them up as needed - you can also manage your servers directly in the Methodius UI.

### Methodius MCP Configuration UI
...
The MCP Management UI will show you all the MCP Servers that are available to use in Methodius. You can also:
...
_This property is **specific to Methodius only** and will have no effect on other tools._
...
To do this, Methodius respects the `Methodius.autoStart` property in the MCP Server configuration file.
