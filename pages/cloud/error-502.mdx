---
title: "502 Error on Methodius Hosted"
...
<Callout type="warning" emoji="️⚠️">
  **Notice**
  This page only applies to the Hosted Cloud version of Methodius and only applies to those using the built-in embedder model.
...
### I am getting a 502 on my hosted Methodius!
...
<Image
  ...
  width={500}
  quality={100}
  alt="Methodius Subscription Item"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="Methodius Subscription Dashboard"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="Methodius Subscription Reboot"
/>
...
- [Switch to a cloud based embedder](/Methodius-setup/embedder-configuration/overview#cloud-model-providers)
