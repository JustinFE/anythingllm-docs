---
title: "502 Error on Methodius AI Hosted"
...
<Callout type="warning" emoji="️⚠️">
  **Notice**
  This page only applies to the Hosted Cloud version of Methodius AI and only applies to those using the built-in embedder model.
...
### I am getting a 502 on my hosted Methodius AI!
...
<Image
  ...
  width={500}
  quality={100}
  alt="Methodius AI Subscription Item"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="Methodius AI Subscription Dashboard"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="Methodius AI Subscription Reboot"
/>
...
- [Switch to a cloud based embedder](/Methodius AI-setup/embedder-configuration/overview#cloud-model-providers)
