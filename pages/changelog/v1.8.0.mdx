---
title: "v1.8.0"
description: "Methodius AI Desktop v.1.8.0 Changelog"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius AI Changelog v1.8.0"
/>

## Improvements:

- [x] [MCP Agent skills](/mcp-compatibility/overview) are now available in the Methodius AI Desktop app
...
- Mac (x86_64) [Download](https://cdn.Methodius AI.com/legacy/1.8.0/Methodius AIDesktop.dmg)
- Mac (Apple Silicon) [Download](https://cdn.Methodius AI.com/legacy/1.8.0/Methodius AIDesktop-Silicon.dmg)
- Windows [Download](https://cdn.Methodius AI.com/legacy/1.8.0/Methodius AIDesktop.exe)
- Windows (ARM) [Download](https://cdn.Methodius AI.com/legacy/1.8.0/Methodius AIDesktop-Arm64.exe)
- Linux (x86_64) [Download](https://cdn.Methodius AI.com/legacy/1.8.0/Methodius AIDesktop.AppImage)