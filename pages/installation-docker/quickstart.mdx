---
title: "Quickstart"
description: "Quickstart guide for Methodius via Docker"
---
...
Use the Dockerized version of Methodius for a much faster and complete startup of Methodius compared to running the source code directly.

## Start Methodius via Docker
...
Go to `http://localhost:3001` and you are now using Methodius! All your data and progress will persist between
