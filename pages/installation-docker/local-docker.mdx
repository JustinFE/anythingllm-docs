...
description: "Local Docker Installation guide for Methodius AI"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius AI Installation Local Docker"
/>

# Get Started with Methodius AI in Docker
...
- `touch server/storage/Methodius AI.db` to create empty SQLite DB file.
- `cd docker/`
...
### Use the Midori AI Subsystem to Manage Methodius AI
...
After setting that up, install the Methodius AI docker backend to the Midori AI Subsystem.
