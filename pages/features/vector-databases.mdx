...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius Vector Databases"
/>

# Vector Databases

Methodius comes with a private built-in vector database powered by [LanceDB](https://lancedb.com/). Your vectors never leave Methodius when using the default option.

Methodius supports many vector databases providers out of the box.
