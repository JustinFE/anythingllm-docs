...
description: "Methodius AI allows you to use a host of LLM providers for chatting and generative AI."
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius AI Vector Databases"
/>

# Vector Databases

Methodius AI comes with a private built-in vector database powered by [LanceDB](https://lancedb.com/). Your vectors never leave Methodius AI when using the default option.

Methodius AI supports many vector databases providers out of the box.
...
<Cards>
  <Card title="LanceDB (Built-in)" href="support.forwardedge.ai"> 
    <Image
...
<Card title="PGVector" href="support.forwardedge.ai"> 
  <Image
...
<Card title="Chroma" href="support.forwardedge.ai">
  <Image
  ...
  <Card title="Milvus" href="support.forwardedge.ai"> 
    <Image
