...
<Callout type="info" emoji="️💡">
  Methodius can have varying default variables depending on if you are using the **Methodius via Docker** or **Methodius Desktop** version.
</Callout>

Methodius comes with a set of default variables that you can use in your system prompt. You can view the full list of active variables by clicking on the **System Prompt Variables** link in the sidebar under **Tools** when on the settings page.
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius System Prompt Variables"
...
| `{user.name}` | The name of the user | Methodius Docker (with multi-user mode enabled) |
| `{user.bio}` | The bio field of the user | Methodius Docker (with multi-user mode enabled) |
| `{os.name}` | The name of the operating system | Methodius Desktop |
| `{os.arch}` | The architecture of the operating system | Methodius Desktop |

_Note: Any time based variable will the current time **of the machine** Methodius is running on. Keep this in mind in Docker based versions of Methodius._
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius Custom Variables"
/>
