...
Methodius AI allows you to use a host of LLM providers for chatting and generative AI.
...
<Card title="KobaldCPP" href="support.forwardedge.ai">
  <Image
  ...
  <Card title="OpenAI (generic)" href="/Methodius AI-setup/llm-configuration/cloud/openai-generic"> 
    <Image
      src="/images/features/language-models/openai.png" 
      height={1080} 
      width={1920} 
