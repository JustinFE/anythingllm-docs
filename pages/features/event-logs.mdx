...
The Event Logs page in Methodius AI allows users to view and monitor various events that occur within the application.
...
Useful for monitoring your Methodius AI instance.
