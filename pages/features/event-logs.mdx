...
The Event Logs page in Methodius allows users to view and monitor various events that occur within the application.
...
Useful for monitoring your Methodius instance.
