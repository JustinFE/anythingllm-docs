---
title: "All Features"
description: "All the features of Methodius AI"
---
...
<Cards>
  ...
  <Card title="API Access & Keys" href="api">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI API Access & Keys"
    />
  </Card>
  ...
  <Card title="Embedded Chat Widgets" href="chat-widgets">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Embedded Chat Widgets"
    />
  </Card>
  ...
  <Card title="Large Language Models" href="language-models">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Large Language Models"
    />
  </Card>
  <Card title="Embedding Models" href="embedding-models">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Embedding Models"
    />
  </Card>
  <Card title="Transcription Models" href="transcription-models">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Transcription Models"
    />
  </Card>
  <Card title="Vector Databases" href="vector-databases">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Vector Database"
    />
  </Card>
  <Card title="Security & Access" href="security-and-access">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Security & Access"
    />
  </Card>
  <Card title="Privacy & Data Handling" href="privacy-and-data-handling">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Privacy & Data Handling"
    />
  </Card>
  <Card title="Cloud Deployment" href="/installation-docker/cloud-docker">
    <Image
      ...
      width={1920}
      quality={100}
      alt="Methodius AI Cloud Deployment"
    />
  </Card>
