---
title: "Chat Modes"
description: "Understanding the difference between Query and Chat modes in Methodius"
---

import { Callout } from "nextra/components";
import Image from "next/image";

# Chat Modes in Methodius

Methodius offers two ways to chat with your documents: Query mode and Chat mode. Let's understand what each does and how to get the best results.
