---
title: "Roadmap"
description: "Feature & product roadmap for Methodius Docker & Desktop"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius Roadmap"
/>

# The Roadmap

At Methodius, we're dedicated to making the most advanced LLM application available to everyone. We want to empower everyone to be able leverage LLMs for their own use for both non-technical and technical users.
...
- [x] The Methodius Community Hub (sharing plugins, prompts, workspaces, etc.)
- [x] Private Methodius Hub (sharing workspaces, prompts, plugins, etc. but private)
...
- [x] Simplified Token Tracking and monitoring sub-service (simple SDK that will be included in Methodius Desktop & Docker)
