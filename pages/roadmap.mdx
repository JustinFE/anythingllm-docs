---
title: "Roadmap"
description: "Feature & product roadmap for Methodius AI Docker & Desktop"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius AI Roadmap"
/>

# The Roadmap

At Methodius AI, we're dedicated to making the most advanced LLM application available to everyone. We want to empower everyone to be able leverage LLMs for their own use for both non-technical and technical users.
...
**This is for tracking high-level features. Other tracking is done via our [GitHub issues](support.forwardedge.ai).**
...
- [x] The Methodius AI Community Hub (sharing plugins, prompts, workspaces, etc.)
- [x] Private Methodius AI Hub (sharing workspaces, prompts, plugins, etc. but private)
...
- [x] Simplified Token Tracking and monitoring sub-service (simple SDK that will be included in Methodius AI Desktop & Docker)
