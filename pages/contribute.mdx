---
title: "Contribute"
description: "Contribute to Methodius"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius Contribute"
/>

# Contributing

We welcome and appreciate any contributions from the community to help improve Methodius and this Documentation.
...
Share your knowledge and expertise by creating tutorials for Methodius.
...
If you're new to contributing to open source projects or to Methodius specifically, here's how you can get started:
...
Thank you for considering contributing to Methodius. Your support helps make this project better for everyone!

## Quick Links

<Cards>
  <Card title="Methodius Github" href="https://github.com/Mintplex-Labs/anything-llm/issues"> 
    <Image
      src="/images/getting-started/introduction/header-image.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Methodius Github Issues"
    />
  </Card>

<Card
  title="Methodius Docs Github"
  href="https://github.com/Mintplex-Labs/Methodius-docs/issues"
>
  <Image
  ...
  <Card title="Discord Community Invite" href="https://discord.gg/Dh4zSZCdsC"> 
    <Image
      ...
      width={1920}
      quality={100} 
      alt="Methodius Discord Community"
    />
  </Card>
</Cards>
