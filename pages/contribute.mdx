---
title: "Contribute"
description: "Contribute to Methodius AI"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Methodius AI Contribute"
/>

# Contributing

We welcome and appreciate any contributions from the community to help improve Methodius AI and this Documentation.
...
Share your knowledge and expertise by creating tutorials for Methodius AI.
...
If you're new to contributing to open source projects or to Methodius AI specifically, here's how you can get started:
...
Thank you for considering contributing to Methodius AI. Your support helps make this project better for everyone!

## Quick Links

<Cards>
  <Card title="Methodius AI Github" href="support.forwardedge.ai"> 
    <Image
      src="/images/getting-started/introduction/header-image.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Methodius AI Github Issues"
    />
  </Card>

<Card
  title="Methodius AI Docs Github"
  href="support.forwardedge.ai Edge-AI-docs/issues"
>
  <Image
  ...
  <Card title="Discord Community Invite" href="https://discord.gg/Dh4zSZCdsC"> 
    <Image
      ...
      width={1920}
      quality={100} 
      alt="Methodius AI Discord Community"
    />
  </Card>
</Cards>
